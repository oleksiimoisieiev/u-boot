...
//	setbits_le32(base, PCIE_RGR1_SW_INIT_1(pcie), 0x4);
//
//	/* Turn off SerDes */
...
//		     PCIE_HARD_DEBUG_SERDES_IDDQ_MASK);
	...
	/* Shutdown bridge */
//	setbits_le32(base, PCIE_RGR1_SW_INIT_1(pcie), RGR1_SW_INIT_1_INIT_MASK);
